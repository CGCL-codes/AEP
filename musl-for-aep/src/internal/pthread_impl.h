...
static inline void __wake(volatile void *addr, int cnt, int priv)
{
	...
	__syscall(SYS_futex, addr, FUTEX_WAKE|priv|FUTEX_LOCK_IN_PV, cnt) != -ENOSYS ||
	__syscall(SYS_futex, addr, FUTEX_WAKE|FUTEX_LOCK_IN_PV, cnt);
}
static inline void __futexwait(volatile void *addr, int val, int priv)
{
	if (priv) priv = FUTEX_PRIVATE;
	__syscall(SYS_futex, addr, FUTEX_WAIT|priv|FUTEX_LOCK_IN_PV, val, 0) != -ENOSYS ||
	__syscall(SYS_futex, addr, FUTEX_WAIT|FUTEX_LOCK_IN_PV, val, 0);
}
