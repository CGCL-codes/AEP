...
int pipe2(int [2], int);
int close(int);
int pv_close(int, int);
int posix_close(int, int);
int dup(int);
int dup2(int, int);
int dup3(int, int, int);
off_t lseek(int, off_t, int);
off_t pv_lseek(int, int, off_t, int);
int fsync(int);
int fdatasync(int);

ssize_t read(int, void *, size_t);
ssize_t pv_read(int, int, void *, off_t, size_t);
void print_count(int);
ssize_t write(int, const void *, size_t);
ssize_t pv_write(int, int, const void *, off_t, size_t, int, unsigned long);
